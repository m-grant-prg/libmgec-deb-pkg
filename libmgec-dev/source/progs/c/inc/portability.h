/**
 * @file libmgec-dev/source/progs/c/inc/portability.h
 *
...
#else
/**
 * BEGIN_C_DECLS should be used at the beginning of declarations so that C++
 * compilers don't mangle their names.
 */
